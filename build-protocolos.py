  ...
  <div class="wrap">
    ...
    <div class="pf__rej">
      ...
      <section class="pf__b">
        ...
        <ul class="pf__l"><li><a href="manual.html#m-pasa-exactamente-cuando-puesto-no-cumple">Ver la matriz de obligaciones</a></li></ul>
      </section>
      <section class="pf__b">
        ...
        <ul class="pf__l">
          ...
          <li><a href="index.html#p-rubrica-auditoria-primera-visita">Rúbrica de auditoría de una Primera Visita</a></li>
        </ul>
      </section>
    </div>
  </div>
