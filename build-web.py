...
.cerrar{position:absolute;top:1rem;left:1rem;right:auto;width:2.2rem;height:2.2rem;line-height:1;
...
/* la X va arriba a la izquierda: se deja hueco para que no pise el texto */
.portal__caja,.voz__caja,.indice__caja{padding-top:3.7rem}
...
.indice__caja{background:var(--panel);border:1px solid var(--pizarra-linea);border-radius:22px;
  ...
  padding:clamp(1.8rem,4vw,3rem);padding-top:3.7rem;position:relative;max-height:86vh;overflow:auto;
