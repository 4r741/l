...
("A11","G1","Programa de salud bucodental para empresas del polígono, del termalismo y de la administración",
...
("A16","G2","Página por localidad de la provincia con el tiempo real de desplazamiento y dónde aparcar",
 "Sabe si le compensa venir desde Verín, O Carballiño o Xinzo antes de llamar","DG","€","trim",2,
...
("A69","G7","Acuerdo con asociaciones de emigrantes y concellos: diagnóstico y plan en la primera estancia",
 "No vuelve a marcharse con un problema que va a estallar a mil kilómetros de quien le conoce","GER","€€","trim",4,
 "Planes abiertos en estancia","amarillo","—"),
("A70","G7","Campaña del Retorno: ventana de tratamiento ajustada al calendario real de las estancias",
 "Se trata en las semanas en que está aquí, sin gastar la estancia en salas de espera","GER","€€€","año",4,
 "Tratamientos completados dentro de ventana","amarillo","—"),
("A71","G7","Informe clínico para continuar fuera, dirigido al propio paciente",
 "Se marcha con un papel que dice cómo tiene la boca y qué falta","DR","€","año",3,
 "Informes emitidos","naranja","—"),
("A72","G7","Protocolo de urgencia a distancia y qué llevarse al volver a marchar",
 "Sabe qué hacer si le duele una muela lejos de aquí","DR","€","año",2,
