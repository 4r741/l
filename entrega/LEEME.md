...
| Archivo | Qué es |
| --- | --- |
| `centro.html` | **La web del centro.** Nueve secciones —Inicio, Dirección, Presentación, Protocolos, Primera Visita, Operaciones, Marketing, Otros y Los números—; al pulsar una en el índice de arriba se despliegan sus apartados. Cada sección lleva su documento entero, más el bloque que ese documento pide: el reloj de los 123 minutos y los carriles de quién tiene al paciente, la matriz RACI de los seis puestos, la tabla de las 76 acciones que se filtra, el puente de 720.000 € a 1,2 M€. Negro, gris y blanco, con un solo color para lo que importa. Ningún enlace sale de su sección. Buscador de teclado (`⌘K`), glosario emergente y lupa para las figuras. Doble clic y se abre, sin conexión. |
