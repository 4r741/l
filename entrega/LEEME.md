...
| Archivo | Qué es |
| --- | --- |
| `centro.html` | **La web del centro.** Siete secciones construidas cada una para lo que cuenta —la primera visita como un reloj de 123 minutos con sus doce fases y los carriles de quién tiene al paciente; los seis puestos como una matriz de catorce fases; el marketing como una tabla de 76 acciones que se filtra; Giraldo Te Cuida, los protocolos y los números con sus cifras salidas del modelo— y una biblioteca con los ocho documentos completos y sus 135 apartados. Buscador de teclado (`⌘K`), glosario emergente, lupa para las figuras y panel de recursos. Doble clic y se abre, sin conexión. |
