...
D = [
 ...
 ("D9", "Regla de cartera de innovación 70/20/10", "Esta sesión",
  ...
  "Otros documentos, 8 · apartado 6 del Plan de Dirección", "Reparto ejecutado frente al aprobado"),
 ("D10", "Orden de prelación del capital", "Esta sesión",
  ...
  "apartado 15 del Plan de Dirección · presupuesto anual", "Ejecución por prioridad, trimestral"),
 ("D11", "Condición de apertura de segunda unidad", "Esta sesión",
  "Establecer que no se autoriza búsqueda de plaza ni compromiso inmobiliario sin acreditar los pasos 3 y 4 del apartado 10.",
  ...
  "apartado 10 del Plan de Dirección", "Un trimestre en umbral sin intervención de Dirección"),
 ...
 ("D15", "Objetivo de facturación y horizonte", "Esta sesión",
  "Fijar la cifra de facturación anual y el ejercicio en que se exige, y aprobar la cartera de nueve campañas del apartado 21 como contenido de D4.",
  ...
  "apartados 20 a 23 del Plan de Dirección · presupuesto anual", "Facturación anual frente a la senda de apartado 22"),
