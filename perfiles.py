...
PERFILES = [
    ...
    dict(
        ...
        vanguardia=[("2.1 · Preparación anticipada del caso", "m-funcion-2-1-preparacion-anticipa"),
                    ("2.2 · Diagnóstico integral y predictivo", "m-funcion-2-2-diagnostico-integral"),
                    ("2.3 · Planificación digital del tratamiento", "m-funcion-2-3-planificacion-digita"),
                    ("2.4 · Consentimiento informado real", "m-funcion-2-4-consentimiento-infor"),
                    ("2.5 · Ejecución clínica", "m-funcion-2-5-ejecucion-clinica"),
                    ("2.6 · Registro y trazabilidad", "m-funcion-2-6-registro-trazabilida")],
    ),
    dict(
        ...
        vanguardia=[("1.1 · Gestión de la demanda", "m-funcion-1-1-gestion-demanda"),
                    ...
                    ("1.4 · Gestión económica de mostrador", "m-funcion-1-4-gestion-economica-mo"),
                    ("1.5 · Seguimiento y recuperación", "m-funcion-1-5-seguimiento-recupera")],
    ),
    dict(
    ...
    dict(
        ...
        vanguardia=[("4.1 · Gestión de equipos", "m-funcion-4-1-gestion-equipos"),
                    ...
                    ("4.3 · Esterilización y bioseguridad", "m-funcion-4-3-esterilizacion-biose")],
    ),
    dict(
        ...
        vanguardia=[("3.1 · Programa de mantenimiento", "m-funcion-3-1-programa-mantenimien"),
                    ("3.2 · Detección precoz y derivación", "m-funcion-3-2-deteccion-precoz-der"),
                    ("3.3 · Monitorización remota", "m-funcion-3-3-monitorizacion-remot"),
